    ...
    tee /tmp/ceph.yaml << EOF
      ...
      images:
        tags:
          ...
          ceph_config_helper: 'docker.io/sdevd/ceph-config-helper:v1.10.3'
          ceph_rbd_pool: 'docker.io/sdevd/ceph-config-helper:v1.10.3'
          ceph_mon_check: 'docker.io/sdevd/ceph-config-helper:v1.10.3'
...
.. code-block:: console
  ...
  Containers:
    ceph-mon:
      ...
      Image:         docker.io/sdevd/ceph-config-helper:v1.10.3
